...
@section('content')
    ...
    <div class="max-w-4xl p-8 mx-auto mt-6 bg-white rounded-lg shadow-lg">
        ...
        <div class="mt-6 text-center">
            <a href="{{ route('view.my.appointment') }}" class="inline-block px-6 py-3 font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
