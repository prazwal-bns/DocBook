    ...
    <div class="container flex items-center justify-between mx-auto">
        ...
        <div class="flex items-center space-x-6">
            ...
            <a href="{{ route('make.appointment') }}"
                class="px-4 py-2  text-white transition-all duration-300 rounded {{ request()->routeIs('make.appointment') ? 'font-bold border-b-4 border-yellow-300' : '' }} hover:text-yellow-300 hover:border-b-2 hover:border-yellow-300">
                Make Appointment
            </a>
