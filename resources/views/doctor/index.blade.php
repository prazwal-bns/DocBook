...
<div class="container flex-1 px-4 mx-auto mt-10">
    ...
    <h1 class="mb-8 text-2xl font-bold text-center text-gray-700">Having a Good Day, Dr. {{ auth()->user()->name }} ??</h1>
    ...
    <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="p-6 bg-white rounded-lg shadow-lg hover:shadow-2xl">
            ...
            <p class="text-gray-600">Gender: {{ ucfirst($doctor->gender) ?? 'Not Specified' }}</p>
            <p class="text-gray-600">Specialization: {{ $doctor->specialization->name ?? 'Not Specified' }}</p>
        </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow-lg hover:shadow-2xl">
            ...
            <p class="text-gray-600">Cancelled: {{ $appointments->where('status', 'cancelled')->count() }}</p>
        </div>

        <!-- Card 3: Other Info (Optional) -->
        <div class="p-6 bg-white rounded-lg shadow-lg hover:shadow-2xl">
