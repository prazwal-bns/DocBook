...
<div class="flex-1 bg-gray-100">
    <div class="px-6 py-12 sm:px-8">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <h2 class="text-3xl font-semibold text-gray-800">Add Specialization</h2>
            <p class="mt-4 text-lg text-gray-600">
                {{ __("Please fill out the form below to add a new specialization.") }}
            </p>
            ...
            <!-- Specialization Form -->
            <form action="{{ route('store.specialization') }}" method="POST" class="mt-6">
                @csrf
                <div class="mb-4">
